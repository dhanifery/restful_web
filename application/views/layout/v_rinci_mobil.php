...
<body>
        ...
        <header>
                <nav class="container">
                        ...
                        <a href="<?= base_url('home')?>" class="logo">BI<span class="danger">-STIR</span></a>
                        <div class="link">
                                <ul>
                                        <li>
                                        ...
                                        <li>
                                                <a href="<?= base_url('home')?>#testi" class="nav-link">Instruktur</a>
                                        </li>
                                        <li>
                                        ...
                                        <div class="profile_dd">
                                                ...
                                                <div class="profile_down">
                                                        <ul class="profile_ul">
                                                          ...
                                                          <li class="profile_li"><a class="profile" href="#"><i class="uil uil-signout"></i> Log Out </a></li>
                                                        </ul>
                                                      </div>
                                        </div>
                                </div> -->
        ...
        <main>
                <section hidden class="showcase-area" id="home">
                        <img src="<?= base_url()?>/assets/images/home/square1.png" class="shape square" alt="">
                        <div class="container">
                                <div class="showcase-info">
                                        <h3 class="sub-heading">B I S T I R</h3>
                                        <h1 class="heading">Welcome to our Website</h1>
                                        <p class="text">Selamat datang di B I S T I R.
                                        </p>
                                        <div class="cta">
                ...
                <section  hidden class="about section" >
                        <img src="<?= base_url()?>/assets/images/home/triangle.png" class="shape triangle" alt="">
                        <div class="container">
                                ...
                                <div class="about-info">
                                        ...
                                        <h1 class="heading">Better design, <br>better experiences</h1>
                                        <p class="text">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Sunt, repudiandae?
                                                Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsa ea tempore mollitia vero
                                                 unde autem esse aliquam dignissimos dolorem praesentium asperiores eius maxime accusantium 
                                                 iusto dolorum, repellendus aliquid! Veniam, vero?
                                        </p>
                                        <div class="cta">
                                                <a href="" class="btn">Contact me</a>
                                                <a href="" download class="btn secondary-btn">Download CV</a>
                                        </div>
                                </div>
                        </div>
                </section>

                <section hidden class="skills section">
                        <div class="container">
                                <div class="skills-box">
                                        <div class="box-heading">
                                                <h3 class="sub-heading">My Skills</h3>
                                                <h1 class="heading">Let me help you</h1>
                                                <div class="box-desc">
                                                        <p class="text">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Sunt, repudiandae?
                                                                Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsa ea tempore mollitia vero
                                                                 unde autem esse aliquam dignissimos dolorem praesentium asperiores eius maxime accusantium 
                ...
                <section hidden class="portfolio section" >
                        <div class="modal">
                        ...
                        <div class="container">
                                <div class="portfolio-header">
                                        <div class="portfolio-title">
                                                <h3 class="sub-heading"><?= $title_course?></h3>
                                                <h3 class="heading"><?= $title_paket?></h3>
                                        </div>
                                ...
                                <div class="portfolio-gallery">
                                        ...
                                        <div class="mix prt-card paket">
                                                ...
                                                <div class="prt-desc">
                                                        ...
                                                        <a href="<?=  base_url('home/rinci_paket/' .$value->id_paket)?>" class="btn secondary-btn sm">Read more</a>
                                                </div>
                                        ...
                                        <div class="mix prt-card mobil">
                                                ...
                                                <div class="prt-desc">
                                                        ...
                                                        <a href="<?=  base_url('home/rinci_mobil/' .$value->id_mobil)?>" class="btn secondary-btn sm">Read more</a>
                                                </div>
                ...
                <section hidden class="testimonials section">
                        <div class="container">
                ...
                <section hidden class="contact section" id="contact"> 
                        <img src="<?= base_url()?>/assets/images/home/triangle.png" class="shape triangle">
                        <div class="container">
                ...
                <section hidden class="subscription section">
                        <div class="container">
                                <img src="<?= base_url()?>/assets/images/home/map.png" alt="" class="map">
                                <div class="sub-box">
                                        <img src="<?= base_url()?>/assets/images/home/square2.png" class="shape square">
                                        <div class="sub-info">
                                                <h3 class="sub-heading">Newsletter</h3>
                                                <h1 class="heading">Get news about my projects</h1>
                                                <p class="text">
                                                        Lorem ipsum dolor sit amet consectetur adipisicing 
                                                        elit. Cupiditate corporis odit laudantium? Porro hic
                                                        voluptas fugit eligendi incidunt deleniti iure quibusdam!
                                                        Explicabo, officia tempore! Explicabo deserunt similique at aspernatur natus.
                                                </p>
                                        </div>
