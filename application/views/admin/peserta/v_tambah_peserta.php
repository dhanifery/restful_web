<div class="recent-orders">
     ...
     <div class="edit-form">
          ...
          <div action="" class="contact-form">
               ...
               echo form_open_multipart('crud_peserta/add') ?>
               <h3>Form Daftar</h3>
               <input type="text" class="form-input" name="username_peserta" value="<?= set_value('username_peserta') ?>" autocomplete="off" placeholder="Username" required>
               <div class="form2">
                    <input type="email" name="email_peserta" class="form-input" value="<?= set_value('email_peserta') ?>" autocomplete="off" placeholder="Email">
                    <div hidden class="hidden">
                         <input type="date" class="form-date">
                    </div>
                    <input type="text" name="TTL" class="form-date" value="<?= set_value('TTL') ?>" name="TTL" onfocus="(this.type='date')" onblur="if(this.value) this.type='text'" placeholder="Tanggal lahir">
               </div>
