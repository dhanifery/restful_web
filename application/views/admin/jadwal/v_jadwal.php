                                                        ...
                                                        foreach ($jadwal as $key => $value) { ?>
                                                                <tr>
                                                                        ...
                                                                        <?php } elseif ($value->status_bayar == 1 & $value->status_jadwal == 0) { ?>
                                                                                <td>
                                                                                        <a href="<?= base_url('jadwal_admin/cek_bukti/' . $value->id_jadwal) ?>" class="btn btn-jadwal">
                                                                                                <p>cek bukti</p>
                                                                                        </a>
                                                                                </td>
                                                                        <?php } elseif ($value->status_jadwal == 2 & $value->status_bayar == 1) { ?>
                                                                                <td>
                                                                                        <a href="<?= base_url('jadwal_admin/qr_code/' . $value->id_jadwal) ?>" class="btn btn-jadwal jadwal-danger">
                                                                                                <p>QR-Code</p>
                                                                                        </a>
                                                                                </td>
                                                                        <?php } ?>
                                                                        ...
                                                                        <?php } elseif ($value->status_jadwal == 0 & $value->status_bayar == 1) { ?>
                                                                                <td>
                                                                                        <a href="<?= base_url('jadwal_admin/konfirmasi/' . $value->id_jadwal) ?>" class="btn btn-jadwal jadwal-danger">
                                                                                                <p>Confirm</p>
                                                                                        </a>
                                                                                </td>
                                                                        <?php } elseif ($value->status_jadwal == 2 & $value->status_bayar == 1) { ?>
                                                                                <td>
                                                                                        <!-- <a href="<?= base_url('jadwal_admin/konfirmasi/' . $value->id_jadwal) ?>" class="btn btn-jadwal ">
                                                                                                <p>Delete</p>
                                                                                        </a> -->
                                                                                </td>
                                                                        <?php } else { ?>
