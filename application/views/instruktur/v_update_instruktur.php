                                ...
                                <div class="form-daftar">
                                        ...
                                        <div class="form2">
                                                ...
                                                <div class="form-2">
                                                        ...
                                                        <input type="text" name="TTL" class="form-date" value="<?= $instruktur->TTL ?>" name="TTL" onfocus="(this.type='date')" onblur="if(this.value) this.type='text'" placeholder="Tanggal lahir">
                                                </div>
                                        ...
                                        <div class="form2">
                                                ...
                                                <div class="form-2">
                                                        ...
                                                        <input type="text" class="form-input" name="JK" value="<?= $instruktur->JK ?>" placeholder="JK">

                                                </div>
                                                <div  hidden class="form-2">
                                                        <label for="">Honor*</label>
                                                        <input type="text" class="form-input" name="honor" value="<?= $instruktur->honor ?>" placeholder="honor">
                                                </div>
                                        </div>
